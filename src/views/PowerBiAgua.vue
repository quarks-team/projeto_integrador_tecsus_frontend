<template>
  <transition name="fade" mode="out-in">
    <div v-if="isVisible" class="container-powerbi">
      ...
      <iframe
        title="ModeloDashboardTecSUS_Agua"
        :src="powerBiSrc"
        frameborder="0"
...
export default {
  data() {
    return {
      isVisible: false,
      powerBiSrc:
        'https://app.powerbi.com/reportEmbed?reportId=2240dfc3-c9e0-4fec-9566-cfb4370ce456&autoAuth=true&ctid=cf72e2bd-7a2b-4783-bdeb-39d57b07f76f'
    }
  },
...
.container-header-agua h1 {
  justify-self: flex-start;
  white-space: nowrap;
}

.container-header-agua .top-bar-agua {
